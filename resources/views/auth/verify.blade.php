   ...
   <div class="header d-flex justify-content-center align-items-center">
      <div class="container">
         <div class="row align-items-center">
            <div class="col-xl-4 col-lg-3 text-center"></div>
            <div class="col-8 col-xl-4 col-lg-6 text-center">
               <img src="{{asset('images/accReactive-logo.png')}}" alt="accReactive-logo" class="img-fluid">
               <img src="{{asset('images/accReactive-logo2.png')}}" alt="accReactive-logo" class="img-fluid">
            </div>
         </div>
      </div>
   </div>
...
<!-- content-section -->
<section class="inactiveAcc-part">
   <div class="container">
      <div class="row justify-content-center">
         <div class="col-lg-10 col-12 text-center">
            ...
            <img src="{{asset('images/logo-black.png')}}" alt="logo-black" class="img-fluid mb-4">
         </div>
      </div>
   </div>
</section>
