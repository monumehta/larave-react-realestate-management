                                        ...
                                        <td>
                                            ...
                                            @if($data['new'])
                                                <!--EMAIL CONTENT-->
                                                    ...
                                                    <span>{!!$data['company_name']!!} </span>שם מלא:

                                                    <span>{!!$data['company_email']!!} </span>מייל:

                                                    <span>{!!$data['company_phone']!!} </span>טלפון:

                                                    <span>{!!$data['package']!!} </span>חבילה:
                                                @else
                                                    <strong>שלום מנהל מערכת</strong><br />
                                                    <span>{{$data['client_name']}} </span> מעוניין לשדרג את החבילה שלו לחבילה:<br/><br/>
                                                    <span>{!!$data['package']!!} </span><br/><br/>
