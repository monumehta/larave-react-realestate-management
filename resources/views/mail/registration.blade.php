                                    ...
                                    <tr>
                                        <td>
                                            <div style="padding: 15px 0;">
                                                ...
                                                <span>{{$data['company_name']}} </span> שלום<br/><br/>
                                                תודה על הרשמתך למערכת GOCLEAR!<br/><br/>
                                                מיד לאחר שמנהל המערכת יאשר את הרשמתכם, תוכלו להוסיף פרויקטים חדשים, להעלות תכנים ולהזמין מתעדכנים חדשים שיוכלו לצפות בסטאטוס של הפרויקטים שלהם.<br/><br/>
                                                אנו ניצור איתכם קשר בהקדם.
                                                <br>
                                                <br>
                                                @if(array_key_exists('password',$data))
                                                    סיסמה: {{$data['password']}}<br />
                                                    משתמש: {{$data['login']}}<br />
                                                    לינק למערכת: <a href="http://app.goclear.co.il">app.goclear.co.il</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
